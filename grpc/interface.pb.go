...
func (x *Queen) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Queen) ProtoMessage() {}

func (x *Queen) ProtoReflect() protoreflect.Message {
	mi := &file_grpc_interface_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Queen.ProtoReflect.Descriptor instead.
func (*Queen) Descriptor() ([]byte, []int) {
	return file_grpc_interface_proto_rawDescGZIP(), []int{2}
}

func (x *Queen) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_grpc_interface_proto_rawDesc = []byte{
	...
	,
...
var file_grpc_interface_proto_goTypes = []interface{}{
	(*Token)(nil),     // 0: ping.Token
	(*Candidate)(nil), // 1: ping.Candidate
	(*Queen)(nil),     // 2: ping.Queen
	(*Empty)(nil),     // 3: ping.Empty
}
var file_grpc_interface_proto_depIdxs = []int32{
	0, // 0: ping.Critical.passToken:input_type -> ping.Token
	1, // 1: ping.Critical.election:input_type -> ping.Candidate
	2, // 2: ping.Critical.elected:input_type -> ping.Queen
	3, // 3: ping.Critical.passToken:output_type -> ping.Empty
	3, // 4: ping.Critical.election:output_type -> ping.Empty
	3, // 5: ping.Critical.elected:output_type -> ping.Empty
